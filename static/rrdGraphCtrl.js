    ...
    statics: {
        _config : {
            timeRanges: {
                ...
                "Last 24 Hours":    { order: 3, len: 24, end: 'hour' },
                "Last 7 Days":      { order: 4, len: 7,  end: 'day' },
                "Last 31 Days":     { order: 5, len: 31, end: 'day' },
                "Last 12 Months":   { order: 6, len: 12, end: 'month' },
                "Today":            { order: 7, len: 1,  end: 'day' },
                "This Week":        { order: 8, len: 1,  end: 'week' },
                "This Month":       { order: 9, len: 1,  end: 'month' },
                "This Year":        { order: 10, len: 1, end: 'year' },
                "60 Minutes":       { order: 11, len: 3600},
                "12 Hours":         { order: 12, len: 12*3600},
                "24 Hours":         { order: 13, len: 24*3600},
                "7 Days":           { order: 14, len: 7*24*3600},
                "4 Weeks":          { order: 15, len: 4*7*24*3600},
                "12 Months":        { order: 16, len: 365*24*3600}
            },
