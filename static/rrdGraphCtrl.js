...
qxWeb.define('rrdGraphCtrl',{
    ...
    statics: {
        _config : {
            timeRanges: {
                "Last 5 Minutes":   { order: 0, len: 5, end: 'minute' },
                "Last 15 Minutes":  { order: 1, len: 15, end: 'minute' },
                "Last 60 Minutes":  { order: 2, len: 60, end: 'minute' },
                "Last 6 Hours":     { order: 3, len: 6, end: 'hour' },
                "Last 12 Hours":    { order: 4, len: 12, end: 'hour' },
                "Last 24 Hours":    { order: 5, len: 24, end: 'hour' },
                "Last 2 Days":      { order: 6, len: 2,  end: 'day' },
                "Last 7 Days":      { order: 7, len: 7,  end: 'day' },
                "Last 31 Days":     { order: 8, len: 31, end: 'day' },
                "Last 12 Months":   { order: 9, len: 12, end: 'month' },
                "Today":            { order: 10, len: 1,  end: 'day' },
                "This Week":        { order: 11, len: 1,  end: 'week' },
                "This Month":       { order: 12, len: 1,  end: 'month' },
                "60 Minutes":       { order: 13, len: 3600},
                "12 Hours":         { order: 14, len: 12*3600},
                "24 Hours":         { order: 15, len: 24*3600},
                "7 Days":           { order: 16, len: 7*24*3600},
                "4 Weeks":          { order: 17, len: 4*7*24*3600},
            },
            ...
            switchToCustomOnStartChange: false,
            momentTz: null,
